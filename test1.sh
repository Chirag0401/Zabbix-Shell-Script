...
for metric in "${top_hosts_metrics[@]}"; do
  json_top_hosts_widget='{"type":"top_hosts","name":"Top Hosts by '"$metric"'","x":"0","y":"'"$top_widget_y"'","width":"24","height":"'"$top_widget_height"'","view_mode":"0","fields":[{"type":"0","name":"sort_triggers","value":"1"}]},'
