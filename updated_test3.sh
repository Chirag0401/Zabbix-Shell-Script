...
#            "id": 1
#          }' \
#      "https://operations.ops.ped.local/api_jsonrpc.php"



#      curl -k -X POST -H "Content-Type: application/json" -d '{"jsonrpc": "2.0", "method": "dashboard.get", "params": { "dashboardids": ["268"], "selectPages": "extend", "output": "extend"},"id": 2, "auth": "d6165047b19c9421729ea50b34a389f676338173d50960aa829cd6db7899a07c"}' "https://operations.ops.ped.local/api_jsonrpc.php"
